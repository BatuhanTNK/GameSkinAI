  ...
  return (
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
      ...
      <div className="relative mt-[3px] flex h-[61px] w-[295px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none md:w-[310px] md:flex-grow-0 md:gap-1 xl:w-[310px] xl:gap-2">
        ...
        {/* Dil Seçici (TR / EN Pill) */}
        <div className="flex items-center gap-1 rounded-xl bg-gray-100 p-1 dark:bg-navy-700">
          <MdLanguage className="ml-1 h-4 w-4 text-gray-500 dark:text-gray-400" />
          <button
            type="button"
            onClick={() => changeLanguage('tr')}
            className={`rounded-lg px-2 py-0.5 text-xs font-bold transition-all duration-200 ${
              lang === 'tr'
